 ...
 */
?>
<div class="second two-col-navigation2 two-col-margin" style="background-image:url('<?php the_field('nav_image') ?>')">
	<div class="row justify-content-center">
	<h1 class="col-lg-12 two-col-navigation-header scrollme animateme"
        data-when="enter"
        data-from="1"
        data-to="0"
        data-translatey="200">
	...
	<h3 class="col-lg-12 two-col-navigation-subheader scrollme animateme"
        data-when="enter"
        data-from="1"
        data-to="0"
        data-translatey="200">
	...
	<img class="bg_image" src="<?php the_field('bg_image') ?>" alt="">		
		...
		<?php if(have_rows('navigation_col_two')) : while(have_rows('navigation_col_two')) : the_row(); ?>
			<div class="navigation-spacing-2 col-xl-4 col-lg-4 col-md-4 col-sm-12">
				<div class="navigation-item <?php the_sub_field('outer_outline') ?> <?php the_sub_field('grid'); ?>" style="background-image:url('<?php the_sub_field('img'); ?>')!important">
	                 <span>
	                	<h2><?php the_sub_field('h1'); ?></h2>
						<p><?php the_sub_field('p'); ?></p>

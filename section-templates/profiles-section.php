...
<div class="row">
  ...
  <h2 class="col-sm-3 subheader-text-right"></h2>
...
<div class="row">
  ...
  <p class="col-sm-3 body-text-right"> consectetur adipisicing elit. Totam esse debitis tempore distinctio eveniet architecto repellat tenetur et accusantium quod.</p>
